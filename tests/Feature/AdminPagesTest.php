...
dataset('adminPages', [
    ...
    'knitting subcontracts' => '/admin/knitting-subcontracts',
    'production plans' => '/admin/production-plans',
    'process routes' => '/admin/process-routes',
    'fabric specifications' => '/admin/fabric-specifications',
    'dyeing specifications' => '/admin/dyeing-specifications',
    'fabric rolls' => '/admin/fabric-rolls',
    'roll traceability report' => '/admin/roll-traceability-report',
    'rework report' => '/admin/rework-report',
