        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Rework', 'description' => 'Rework runs, their original order and added cost', 'url' => ReworkReport::getUrl(), 'icon' => 'heroicon-o-arrow-path'],
                    ...
                    ['label' => 'Roll Traceability', 'description' => 'Fabric rolls with batch, source order and input batches', 'url' => RollTraceabilityReport::getUrl(), 'icon' => 'heroicon-o-view-columns'],
