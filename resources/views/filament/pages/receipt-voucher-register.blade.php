<x-filament-panels::page>
    ...
    <x-filament::section>
        <x-slot name="heading">Receipt vouchers</x-slot>
        ...
        @if ($register['count'] === 0)
            <div class="flex flex-col items-center justify-center gap-2 py-10 text-center">
                ...
                <p class="text-sm font-medium text-gray-600 dark:text-gray-300">No receipt vouchers in this period</p>
                <p class="text-xs text-gray-400">Adjust the date range or customer filter above.</p>
            </div>
        @else
